...
실행:
    streamlit run app/02_widget_playground.py

사이드바에서 카테고리를 골라 위젯 9그룹(A~I)을 만져봅니다.
모든 위젯은 자동차 부품 검사 시나리오 컨텍스트.
"""
...
# 푸터
st.divider()
st.caption("QA/QC × Streamlit 5시간 강의 · 2교시 데모 · 정강민")
